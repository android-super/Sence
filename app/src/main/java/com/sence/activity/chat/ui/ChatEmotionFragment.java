...
import com.sence.R;
import com.sence.activity.chat.adapter.EmotionGridViewAdapter;
import com.sence.activity.chat.adapter.EmotionPagerAdapter;
import com.sence.activity.chat.base.BaseFragment;
import com.sence.activity.chat.util.EmotionUtils;
import com.sence.activity.chat.util.GlobalOnItemClickManagerUtils;
import com.sence.activity.chat.util.Utils;
import com.sence.activity.chat.widght.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    private void initEmotion() {
        ...
        // 动态计算item的宽度和高度
        int itemWidth = (screenWidth - spacing * 9) / 9;
        //动态计算gridview的总高度
