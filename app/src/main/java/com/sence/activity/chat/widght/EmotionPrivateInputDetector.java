 ...
 * 输入框管理类
 */
public class EmotionPrivateInputDetector {
    ...
    private EmotionPrivateInputDetector() {
    }

    public static EmotionPrivateInputDetector with(Activity activity) {
        EmotionPrivateInputDetector emotionInputDetector = new EmotionPrivateInputDetector();
    ...
    public EmotionPrivateInputDetector bindToContent(View contentView) {
     ...
     * @return
     */
    public EmotionPrivateInputDetector bindToEditText(EditText editText) {
        mEditText = editText;
...
//                    mAddButton.setVisibility(View.VISIBLE);
     ...
     * @return
     */
    public EmotionPrivateInputDetector bindToEmotionButton(View emotionButton) {
     ...
     * @return
     */
    public EmotionPrivateInputDetector bindToSendButton(View sendButton) {
     ...
     * @return
     */
    public EmotionPrivateInputDetector bindToJPButton(final ImageView jianpanButton) {
    ...
    public EmotionPrivateInputDetector setEmotionView(View emotionView) {
        mEmotionLayout = emotionView;
        return this;
    }

    public EmotionPrivateInputDetector setViewPager(ViewPager viewPager) {
