...
public class IndicatorView extends LinearLayout {
    ...
    public void initIndicator(int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                v.setBackgroundResource(R.drawable.chat_dian_y);
            } else {
                v.setBackgroundResource(R.drawable.chat_dian_n);
            }
            mImageViews.add(v);
            this.addView(v);
        }
    ...
    public void playByStartPointToNext(int startPosition, int nextPosition) {
        ...
        ViewNext.setBackgroundResource(R.drawable.chat_dian_y);
        ViewStrat.setBackgroundResource(R.drawable.chat_dian_n);
    }
