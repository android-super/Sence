 ...
 * 描述:SenceGit
 */
public class ImageBehavior extends CoordinatorLayout.Behavior<NiceImageView> implements AppBarLayout.OnOffsetChangedListener {
    ...
    @Override
    public boolean layoutDependsOn(@NonNull CoordinatorLayout parent, @NonNull NiceImageView child,
    ...
    @Override
    public boolean onDependentViewChanged(@NonNull CoordinatorLayout parent, @NonNull NiceImageView child,
                                          @NonNull View dependency) {
