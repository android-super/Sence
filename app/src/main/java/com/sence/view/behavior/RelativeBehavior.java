 ...
 * 描述:SenceGit
 */
public class RelativeBehavior extends CoordinatorLayout.Behavior<RelativeLayout> implements AppBarLayout.OnOffsetChangedListener {
    private float translate = 0;
    private float scale;

    public RelativeBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @Override
    public boolean layoutDependsOn(@NonNull CoordinatorLayout parent, @NonNull RelativeLayout child,
    ...
    @Override
    public boolean onDependentViewChanged(@NonNull CoordinatorLayout parent, @NonNull RelativeLayout child,
                                          @NonNull View dependency) {
